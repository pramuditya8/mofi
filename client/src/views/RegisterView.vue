        ...
        <div class="col-xxl-4 col-xl-5 col-lg-6 col-md-7 col-sm-10 my-auto">
          <div class="card shadow-lg">
            <div class="card-body p-5">
              <h3 class="card-title fw-bold mb-4">Register</h3>
              <form
                @submit.prevent="handleRegister(data)"
              ...
              >
                <div class="mb-3">
                  ...
                  <p
                    ...
                    :key="index"
                    :class="err.path !== 'username' ? 'd-none' : ''"
                    v-text="err.path === 'username' ? err.message : ''"
                  ></p>
              ...
              <div class="mt-3 text-center">
                <p>
                  ...
                  <a href="" @click.prevent="changePage()">Login</a>
                </p>
              </div>
              <div class="row">
...
export default {
  ...
  methods: {
    ...mapActions(useUsersStore, ["handleRegister", "clearErrors"]),
    changePage() {
      this.clearErrors();
